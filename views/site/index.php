...
<div class="container">
    <div class="row">
        <div class="col-12">
            ...
            <div class="modal fade" id="uploadFilmsModal" tabindex="-1" aria-labelledby="uploadFilmsModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-body">
                            ...
                            <form action="#" method="post" enctype="multipart/form-data">
                                <div class="mb-3">
                                    ...
                                    <input type="file" name="text" class="form-control" id="text" placeholder="" value="">
                                </div>
